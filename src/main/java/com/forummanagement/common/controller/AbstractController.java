package com.forummanagement.common.controller;
...
import com.forummanagement.common.util.DateUtil;
import com.forummanagement.common.util.Util;
import com.forummanagement.controller.HomeBean;
import com.forummanagement.controller.LoginBean;
import com.forummanagement.controller.SessionBean;
import com.forummanagement.dao.CategoryDao;
import com.forummanagement.dao.PostDao;
import com.forummanagement.dao.TopicDao;
import com.forummanagement.validation.ErrorMessage;
import com.forummanagement.validation.ValidationErrors;
...
public abstract class AbstractController {
	...
	/**
	 * The getHomeBean() method is used to get HomeBean instance.
	 *
	 * @return HomeBean object
	 */
	protected HomeBean getHomeBean() {
		return (HomeBean) getControllerObject("homeBean", HomeBean.class);
	}

	/**
	 * The getLoginBean() method is used to get LoginBean instance.
	 *
	 * @return LoginBean object
	 */
	protected LoginBean getLoginBean() {
		return (LoginBean) getControllerObject("loginBean", LoginBean.class);
	}

	protected CategoryDao getCategoryDao() {
		return DaoManager.getInstance().getDao(CategoryDao.class);
	}
	
	protected PostDao getPostDao() {
		return DaoManager.getInstance().getDao(PostDao.class);
	}
	
	protected TopicDao getTopicDao() {
		return DaoManager.getInstance().getDao(TopicDao.class);
	}
